...
envsubst '${PORT} ${NAMESERVER} ${AUTH_SERVICE_URL} ${CONNECTOR_SERVICE_URL} ${CUSTOMER_SERVICE_URL} ${LOAN_SERVICE_URL} ${ELIGIBILITY_SERVICE_URL} ${POLICY_SERVICE_URL} ${COMMISSION_SERVICE_URL} ${MESSAGING_SERVICE_URL} ${DOCUMENT_SERVICE_URL} ${REPORTING_SERVICE_URL} ${ANALYTICS_SERVICE_URL} ${ROUTING_SERVICE_URL}' \
