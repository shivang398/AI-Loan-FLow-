...
const config = {
  ...
  "inlineSchemaHash": "46b192e0bb7f05eafbb1f8279a3a22658200c5324f80e4d252ec73e39195a57b",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/generated/prisma-communications",
    "generated/prisma-communications",
  ]
...
path.join(process.cwd(), "src/generated/prisma-communications/libquery_engine-debian-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/generated/prisma-communications/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/generated/prisma-communications/schema.prisma")
