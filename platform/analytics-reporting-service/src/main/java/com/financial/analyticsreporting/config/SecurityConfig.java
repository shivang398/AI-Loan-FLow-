package com.financial.analyticsreporting.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // A01: analytics write is ADMIN-only — protect KPI data from tampering
                .requestMatchers(HttpMethod.POST, "/analytics/snapshots").hasAuthority("ADMIN")
